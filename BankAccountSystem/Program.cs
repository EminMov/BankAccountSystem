namespace BankAccountSystem
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Make some withdrawals from each account--Her iki accountda cixarish etmelisiniz
            ...
            // More than 3 Savings withdrawals should result in 2.00 charge 3 defeden saving accountdan cixaris edilerse 

            //-2.00 mebleginde komissiya tutulur
            saving.Withdraw(10.0m);//xerce 
            saving.Withdraw(20.0m);
            saving.Withdraw(30.0m);
            // Savings balance should now be 988.63
            Console.WriteLine($"Savings balance is {saving.Balance:C2}");

            // try to overdraw savings - this should be denied and print message-- savingde balansdan boyuk bir mebleg cixaris edilerse o zaman cixarish yerine yetmemelidi yeni hec bir cixarish olmamalidi ve mesaj qaytarilmalidi.
            saving.Withdraw(2000.0m);

            // try to overdraw checking - should result in extra charge 35.00--checkhing-de balansdan boyuk mebleg cixarilarsa menfiye dushecek ve elave 35.00 charge 
